...
```
  npm install @moonmoonbrothers/flutterjs @meursyphus/flitter-chart
```
...
```
 npm install @moonmoonbrothers/flutterjs @meursyphus/flitter-chart @moonmoonbrothers/flutterjs-svelte
```
